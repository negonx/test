...
<div class="p-2">
  ...
  <?php if (($_SESSION['nivel_admin'] ?? 0) == 1): ?>
...
<div class="container-fluid"><div class="row pt-4"><div class="col-md-12 text-center mb-2"><small> © <?php echo date("Y"); ?> EDIT POR <i aria-hidden="true" class="fa fa-heart text-danger"></i> PJ <span class="text-secondary font-weight-bold"></span></small></div><div class="col-md-12 text-center mb-3"><a class="bg-light btn-sm m-2 shadow-sm text-dark" target="_blank"><i class="fa-telegram-plane fab"></i></a></div></div></div></app-footer>
