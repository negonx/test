        ...
        if ($stmt->rowCount() > 0) {
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                if ($total == 0) {
                    ...
                    $delete_stmt_admin = $pdo->prepare($delete_sql_admin);
                    ...
                    $delete_stmt_clientes = $pdo->prepare($delete_sql_clientes);
                    ...
                    $delete_stmt_planos = $pdo->prepare($delete_sql_planos);
...
function edite_revendedor($id)
{
    ...
    if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        $planos_admin = $pdo->query("SELECT * FROM planos_admin WHERE id < $admin_plano");
    ...
    if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        $stmt_insert = $pdo->prepare($sql_insert);
           ...
           if ($stmt_insert->execute()) {
                ...
                $stmt_insert_planos = $pdo->prepare($sql_insert_planos);
